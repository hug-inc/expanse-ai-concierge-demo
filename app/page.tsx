...
function replyFor(input: string, knowledge: KnowledgeDocument[]): Omit<Message, "id" | "role"> {
  ...
  if (/セラピスト.*(採用|求人|条件|給与|給料|月給|時給|未経験|経験者|働)|採用.*セラピスト/.test(text)) return answers["セラピストの採用条件"];
