...
const recruitment: StructuredSource = {
  title: "Expanse 採用情報・セラピスト給与",
  url: "https://expanse.jp/recruit_02",
  passage:
    "Expanseでは、セラピスト、レセプション・カウンセラー、WEBデザイナー、グラフィックデザイナー、WEBマーケター、動画クリエイター、EC shop運営担当、EC Shop運営責任者を募集。セラピストは未経験でも応募可能。公式採用ページ掲載の給与は、未経験の正社員が月給250,000円〜、経験者の正社員が月給260,000円〜。このほか毎月の評価制度（月0〜150,000円）がある。パート・アルバイト・業務委託は時給・時間報酬1,300〜3,500円。勤務は平日10:00〜20:00、土日祝は早番9:00〜19:30・遅番9:30〜20:00で休憩1時間。パート・アルバイト・業務委託は週3日以上、1日5時間以上。年間休日134日、入社6か月後に有給休暇10日。交通費全額支給、社会保険完備、店販手当、最大80％OFFの社員割引、表彰制度が掲載されている。応募フォームはhttps://expanse.jp/recruit_02#entry、採用担当は03-6263-9501（10:00〜17:00）。",
};
